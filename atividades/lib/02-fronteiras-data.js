/* =============================================================================
   ...
   entre ele e o vizinho (a `fronteira` sempre abre com "O que decide:").
  ...
  var ITENS = [
    {
      ...
      fronteira: `<b>O que decide:</b> havia um <b>objeto real</b> (o casaco) que foi <i>deformado</i> → <b>ilusão</b>. A <b>alucinação</b> seria percepção <i>sem objeto</i>. A <b>alucinose</b> também não tem objeto, mas a pessoa <i>reconhece</i> que não é real — aqui, além de existir objeto, ele logo se corrige.`
    },
    {
    ...
    },
    {
      ...
      fronteira: `<b>O que decide:</b> <b>rebaixamento e flutuação do nível de consciência</b>, atenção comprometida e <i>início agudo</i> → <b>delirium</b>. A <b>demência</b> cursa com consciência <i>clara</i> e instalação crônica e progressiva. A <b>síndrome amnéstica</b> é déficit seletivo de memória, com consciência e atenção preservadas.`
    },
    {
      ...
      fronteira: `<b>O que decide:</b> a descarga é <b>explosiva, incontrolável e desproporcional</b> ao estímulo, com pouca modulação → <b>incontinência afetiva</b> (frequente em lesões orgânicas). A <b>labilidade afetiva</b> é a mudança <i>rápida</i> do humor, mas ainda modulável e ligada ao contexto. A <b>hipertimia</b> é elevação <i>sustentada</i> do humor.`
    },
    {
    ...
    },
    {
      ...
      fronteira: `<b>O que decide:</b> <b>interrupção súbita</b> e involuntária do curso, com retomada noutro ponto → <b>bloqueio do pensamento</b>. A <b>lentificação</b> (bradipsiquismo) é o pensamento globalmente mais <i>lento</i>, sem a parada abrupta. O <b>mutismo</b> é a ausência de fala, não uma interrupção do fluxo do pensar.`
    },
    {
